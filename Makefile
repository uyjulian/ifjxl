...
LIBJXL_LIBS += $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libjxl.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libjxl_threads.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libhwy.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libbrotlicommon-static.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libbrotlidec-static.a
...
extractor$(OBJECT_EXTENSION): $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libjxl.a

DEPENDENCY_SOURCE_DIRECTORY_LIBJXL := $(DEPENDENCY_SOURCE_DIRECTORY)/libjxl

# no source archive for libjxl
...
$(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libjxl_threads.a: $(DEPENDENCY_BUILD_DIRECTORY_LIBJXL)/lib/libjxl.a
$(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libhwy.a: $(DEPENDENCY_BUILD_DIRECTORY_LIBJXL)/lib/libjxl.a
$(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libbrotlicommon-static.a: $(DEPENDENCY_BUILD_DIRECTORY_LIBJXL)/lib/libjxl.a
$(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libbrotlidec-static.a: $(DEPENDENCY_BUILD_DIRECTORY_LIBJXL)/lib/libjxl.a

$(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libjxl.a: | $(DEPENDENCY_SOURCE_DIRECTORY_LIBJXL) $(DEPENDENCY_OUTPUT_DIRECTORY)
	cmake \
		-S $(DEPENDENCY_SOURCE_DIRECTORY_LIBJXL) \
