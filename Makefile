...
LIBJXL_LIBS += $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libjxl.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libjxl_threads.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libhwy.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libbrotlicommon.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libbrotlidec.a
...
$(DEPENDENCY_SOURCE_DIRECTORY_LIBJXL): | $(DEPENDENCY_SOURCE_DIRECTORY)
	git clone --depth 1 --branch v0.10.2 --recursive --shallow-submodules $(DEPENDENCY_SOURCE_URL_LIBJXL) $@
...
$(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libbrotlicommon.a: $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libjxl.a
$(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libbrotlidec.a: $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libjxl.a
